...
// 🛡️ IMPORTACIÓN DEL NUEVO MÓDULO BLINDADO
import EscanerProfundo from '../../components/EscanerProfundo';
...
export default function VisorOperativo() {
  ...
  return (
    ...
    <AccesoRestringido>
      <div className="min-h-screen bg-black flex flex-col p-4 gap-4 font-mono pb-24">
        ...
        */}
        <div ref={reporteGlobalRef} className="flex flex-col gap-4 bg-black p-1 print:block print:p-0 print:overflow-visible">
          ...
          */}
          <div className="h-[1000px] md:h-[70vh] print:h-[260mm] print:overflow-hidden w-full border border-[#003300] relative z-0">
            <MapaSatelital />
          </div>

          {/* 🌋 SECTOR B: EL ESCÁNER SUBTERRÁNEO */}
          {/* CORRECCIÓN PDF: print:break-before-page obliga al navegador a imprimir esto en la PÁGINA 2. */}
          <div className="w-full print:break-before-page print:pt-8 print:mt-4 relative z-10">
            {/* INYECCIÓN DEL MÓDULO CON COORDENADAS (Modifique estas coordenadas si logra extraerlas del MapaSatelital) */}
            <EscanerProfundo coordenadas={{ lat: -34.6037, lng: -58.3816 }} />
          </div>
